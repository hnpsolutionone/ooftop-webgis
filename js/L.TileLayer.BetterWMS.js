                    ...
                    if (markers.length) {
                        for (var i = 0; i < markers.length; ++i) {
                            ...
                            var marker = L.marker([parseFloat(markers[i].lat), parseFloat(markers[i].long)], {icon: myIcon})
                                .bindPopup('<strong>School information</strong> <br />' + (markers[i].appariement !== null ? '<strong>Appariement</strong>: ' + markers[i].appariement : '') + '<br />' + (markers[i].appellation_officielle !== null ? '<strong>Appellation officielle</strong>:' + markers[i].appellation_officielle : ''))
                                .addTo(map);
                            mapMarkers.push(marker);
                        }
                    }
